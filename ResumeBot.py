...
#     repo_id="kaushikee01/Llama_3_1_finetuned_model",
...
3. Frame your answers in such a way that they showcase Kaushikee's importance.
Resume:
{context}
...
side_bar_message = """Hi there, I’m [Kaushikee](https://linkedin.com/in/kaushikee-bhawsar-54127b177), and I’ve developed this virtual assistant,
 **KBot**, to help you navigate through my professional background efficiently.
...
# Evaluation section
# st.sidebar.header("Evaluate KBot RAG Pipeline")

# if st.sidebar.button('Evaluate'):
    
#     queries = ["How many years of work experience she has?"]
#     ground_truths = [
#         { 
#             'contexts':["Kaushikee has 3+ years of experience in Software Development and Quality Assurance"], 
#             'answer': '''Kaushikee has 3+ years of experience in Software Development and Quality Assurance'''
#         }
#     ]
